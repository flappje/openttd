# OpenTTD [![Docker Version](https://img.shields.io/docker/v/flappje/openttd?sort=semver)](https://hub.docker.com/r/flappje/openttd/) [![Docker Pulls](https://img.shields.io/docker/pulls/flappje/openttd.svg?maxAge=600)](https://hub.docker.com/r/flappje/openttd/) [![Docker Stars](https://img.shields.io/docker/stars/flappje/openttd.svg?maxAge=600)](https://hub.docker.com/r/flappje/openttd/)
...
[![dockeri.co](https://dockeri.co/image/flappje/openttd)](https://hub.docker.com/r/flappje/openttd)
## Usage ##
